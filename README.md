...
The `@juango/ui` package provides React components and utilities:
...
import {
  ...
  BreadcrumbProvider, useBreadcrumb,
...
```tsx
import { AuthProvider, AdminProvider, ProtectedRoute } from '@juango/ui'
